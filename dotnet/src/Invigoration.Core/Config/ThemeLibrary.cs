...
public static class ThemeLibrary
{
    ...
    [
        ...
        // white lettering on its plates. Was a near-black walnut, which hid the grain.
        new()
        {
            Id = WarcraftIIIId,
            Name = "Warcraft III",
            ...
            Materials = new() { Lettering = 0xFFFFFF, Band = 0x8A5E38, BandShade = 0x4A2E19, Trim = 0x5C5751, TrimShade = 0x1F1D1B, Metal = 0x4A4C50, Accent = 0xD9BE7C, Well = 0x0A0705 },
        },
    ];
